...
url = "https://pelisjuanita.com/series/script.js?v=1.30.8"
...
headers = {
    ...
    "Referer": "https://pelisjuanita.com/series/ver-serie/marvel-daredevil/03x02"
}
...
try:
    ...
    print("Saved response to script.js")
